...
*   **توجه مهم:** درخواست‌های عمومی مثل "توضیح بده"، "خلاصه کن"، "بررسی کن"، "چیه این؟" → **invalid نیستند** → به `business_with_file` یا `general` بروند.
*   **فقط** وقتی متن واقعاً بی‌معنی است (مثل "اسیبلا" یا "!!!") این دسته را انتخاب کن.
...
*   **شامل با فایل:** درخواست‌های عمومی درباره فایل‌های غیرتخصصی (رمان، شعر، مقاله عمومی) مثل "توضیح بده"، "خلاصه کن"
...
*   **توجه مهم:** اگر محتوای فایل عمومی است (رمان، شعر، مقاله غیرتخصصی) → به `general` برود نه اینجا.

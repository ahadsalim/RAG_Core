...
**⚠️ قوانین جستجوی وب:**
- تاریخ فعلی: {current_date_shamsi}. منابع قدیمی‌تر از 3 روز را استفاده نکنید
- اگر منبع به "دوشنبه"، "فردا" اشاره کرده، تاریخ انتشار را بررسی کنید
- برای آب‌وهوا/اخبار: فقط منابع امروز یا دیروز معتبر است"""

...
این پوشه شامل تمام مستندات فنی و راهنماهای سیستم RAG Core است.

## 📚 فهرست مستندات

### راهنماهای شروع سریع
- **QUICK_START.md** - راهنمای شروع سریع برای کار با سیستم
- **SYSTEM_STATUS.md** - وضعیت فعلی سیستم و سرویس‌ها

### معماری و طراحی
- **RAG_FLOW_EXPLANATION.md** - توضیح کامل جریان RAG و معماری سیستم
- **QDRANT_OPTIMAL_STRUCTURE.md** - ساختار بهینه Qdrant و vector database

### راهنماهای پیکربندی
- **API_KEYS_SETUP.md** - راهنمای تنظیم API keys برای LLM providers
- **LLM_SETUP_GUIDE.md** - راهنمای پیکربندی مدل‌های زبانی
- **LOCAL_EMBEDDING_GUIDE.md** - راهنمای استفاده از embedding models محلی
- **HUGGINGFACE_LLAMA_SETUP.md** - راهنمای استفاده از Llama via HuggingFace

### یکپارچه‌سازی
- **INGEST_INTEGRATION_GUIDE.md** - راهنمای یکپارچه‌سازی با سیستم Ingest
- **USERS_SYSTEM_NOTES.md** - یادداشت‌های یکپارچه‌سازی با سیستم Users

### Celery و Background Tasks
- **CELERY_IMPLEMENTATION.md** - مستندات کامل پیاده‌سازی Celery

### تغییرات و به‌روزرسانی‌ها
- **IMPLEMENTATION_SUMMARY.md** - خلاصه تغییرات و پیاده‌سازی‌ها
- **INGEST_CHANGES.md** - تغییرات مربوط به یکپارچه‌سازی Ingest
